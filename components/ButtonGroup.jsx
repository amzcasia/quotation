...
export default function ButtonGroup({toggleDisabled, days, setDays, dayIndex, entryIndex }){
    ...
    return(
        <div className='flex flex-col justify-end gap-1'>
            <button type="button" className='hidden px-2 py-1 bg-yellow-400' onClick={toggleDisabled}>Edit</button>
            ...
            <button onClick={handleUp} type="button" 
                className='hidden px-2 py-1 bg-blue-400'>
                    Up
            </button>
           <button onClick={handleDown} type="button" className='hidden px-2 py-1 bg-blue-400'>Down</button>
        </div>
    )
}